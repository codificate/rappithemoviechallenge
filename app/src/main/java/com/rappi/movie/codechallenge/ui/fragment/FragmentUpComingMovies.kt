...
class FragmentUpComingMovies : ScopedFragment(), KodeinAware {
    ...
    private val upComingViewModelFactory: UpComingViewModelFactory by instance()
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        upComingViewModel = ViewModelProviders.of(this, upComingViewModelFactory)
    ...
    private fun setConfigurationData() = launch {
        ...
        configuration.observe(this@FragmentUpComingMovies, Observer {
        ...
        genres.observe(this@FragmentUpComingMovies, Observer {
            if (it == null) return@Observer
    ...
    private fun bindUi() = launch {
        ...
        val discover = upComingViewModel.fetchUpcomingMovies.await()

        discover.observe(this@FragmentUpComingMovies, Observer { movies ->
